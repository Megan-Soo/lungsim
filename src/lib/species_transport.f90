 ...
 subroutine initialise_transport()
   ...
   select case (model_type)
     ...
     case ('gas_transfer')
       ...
       call initial_gasexchange(149.0_dp) ! (MS) edited: uncommented to test gasexchange model. Why was it commented out?
       call solve_transport ! (MS) edited: uncommented to test gasexchange model. Why was it commented out?
 ...
 subroutine solve_transport()
   ...
   select case (model_type)
     ...
     case ('gas_transfer')
       ...
       p_art_o2=100.0_dp
       p_ven_o2=40.0_dp
      call steadystate_gasexchange(c_art_o2,c_ven_o2,& ! (MS) edited: uncommented to test gasexchange model. Why was it commented out?
