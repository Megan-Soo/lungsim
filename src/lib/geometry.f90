module geometry
  ...
  public list_tree_statistics_from_parent ! (MS) added subroutine
...
!!!#############################################################################
  ...
  subroutine list_tree_statistics_from_parent(parent, filename) ! (MS) added
    ...
    sub_name = 'list_tree_statistics_from_parent'
    call enter_exit(sub_name,1)
...
!!! Initialise counters
    ...
    do ne = parent,num_elems ! (MS) edited: start from parent element
       ne0 = elem_cnct(-1,1,ne) ! parent element number
       forall(i=1:3) ind(i) = elem_ordrs(i,ne) ! the gen, Hord, Sord for i=1,2,3
...
!!! Output tree statistics
  ...
  end subroutine list_tree_statistics_from_parent
