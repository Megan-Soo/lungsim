...
module indices
  ...
  integer :: num_nu,nu_vol=0,nu_comp=0,nu_conc2=0,nu_Vdot0=0,nu_Vdot1=0, &
       ...
       nu_vd=0,nu_perf=0,nu_blood_press=0, nu_ppl=0 ! added nu_ppl
  ...
  public num_ne,ne_radius,ne_length,ne_vol,&
       ...
       ne_vd_bel, ne_vol_bel, ne_unstrained_radius
  ...
  !Interfaces
  private
  public define_problem_type,ventilation_indices, perfusion_indices, get_ne_radius, get_ne_unstrained_radius, get_nj_conc1, &
       growing_indices
...
contains
  ...
  subroutine ventilation_indices
    ...
    ! indices for elem_field
    num_ne = 12 !number of element fields
    ...
    ne_vd_bel = 9
    ne_vol_bel = 10
    ne_unstrained_radius = 11 ! Radius(unstrained)
    ne_ppl = 12 ! local plural pressure to element 
...
!!!#############################################################################
  ...
  function get_ne_unstrained_radius() result(res)
    
    implicit none
    character(len=60) :: sub_name
    integer :: res
    
    sub_name = 'get_ne_unstrained_radius'
    call enter_exit(sub_name,1)
    
    res=ne_unstrained_radius
    
    call enter_exit(sub_name,2)
  end function get_ne_unstrained_radius
