...
subroutine evaluate_prq_c(mesh_type,mesh_type_len,vessel_type,vessel_type_len,grav_dirn,grav_factor,bc_type,bc_type_len,inlet_bc, &
               outlet_bc,remodeling_grade,FRC) bind(C, name="evaluate_prq_c")
  ...
  real(dp),intent(in) :: grav_factor,inlet_bc,outlet_bc,remodeling_grade,FRC
  ...
  call evaluate_prq(mesh_type_f,vessel_type_f,grav_dirn,grav_factor,bc_type_f,inlet_bc,outlet_bc,remodeling_grade,FRC)
