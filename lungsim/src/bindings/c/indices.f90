...
!> Perfusion indices
  ...
  function get_ne_unstrained_radius_c() result(res) bind(C, name="get_ne_unstrained_radius_c")

    use indices, only: get_ne_unstrained_radius
    implicit none
    integer :: res

    res = get_ne_unstrained_radius()

  end function get_ne_unstrained_radius_c
