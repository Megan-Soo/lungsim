...
void export_dvdt_bin_c(const char *BINFILE, int *BINFILE_LEN, const char *name, int *name_len);
void export_mapped_voxels_c(const char *EXNODEFILE, int *EXNODEFILE_LEN, const char *name, int *name_len);
void export_mapped_units_c(const char *EXNODEFILE, int *EXNODEFILE_LEN, const char *name, int *name_len);
...
void export_dvdt_bin(const char *BINFILE, const char *name)
{
  int filename_len = strlen(BINFILE);
  int name_len = strlen(name);

  export_dvdt_bin_c(BINFILE, &filename_len, name, &name_len);
}
...
void export_mapped_units(const char *EXNODEFILE, const char *name)
{
  int filename_len = strlen(EXNODEFILE);
  int name_len = strlen(name);

  export_mapped_units_c(EXNODEFILE, &filename_len, name, &name_len);
}
