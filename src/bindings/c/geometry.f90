...
!###################################################################################
!
  subroutine list_tree_statistics_from_parent_c(parent, filename, filename_len) &
       bind(C, name="list_tree_statistics_from_parent_c")

    use iso_c_binding, only: c_ptr
    use utils_c, only: strncpy
    use other_consts, only: MAX_FILENAME_LEN
    use geometry,only: list_tree_statistics_from_parent
    implicit none
    ...
    call list_tree_statistics_from_parent(parent, filename_f)

  end subroutine list_tree_statistics_from_parent_c
!
!###################################################################################
!
