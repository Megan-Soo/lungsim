...
SHO_PUBLIC void export_1d_elem_ipfiel(int ne_field, const char *IPELEMFILE, int last_elem);
...
SHO_PUBLIC void export_dvdt(const char *EXNODEFILE, const char *name);
SHO_PUBLIC void export_dvdt_bin(const char *BINFILE, const char *name);
SHO_PUBLIC void export_mapped_voxels(const char *EXNODEFILE, const char *name);
SHO_PUBLIC void export_mapped_units(const char *EXNODEFILE, const char *name);
