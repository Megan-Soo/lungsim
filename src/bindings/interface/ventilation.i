...
%apply (double* INPLACE_ARRAY2, int DIM1, int DIM2) {(double* flow_out, int n, int dim)}
%apply (double* INPLACE_ARRAY2, int DIM1, int DIM2) {(double* t_out, int n, int dim)}
%apply (double* INPLACE_ARRAY2, int DIM1, int DIM2) {(double* f_out, int n, int dim)}
